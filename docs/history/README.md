...
**文档作用：** **索引** `docs/history/*.md` 按日开发记录；不写具体技术细节（细节在对应日期文件中）。策略见 [`../specs/DOCUMENTATION-POLICY.md`](../specs/DOCUMENTATION-POLICY.md) §0。
...
策略说明：[`../specs/DOCUMENTATION-POLICY.md`](../specs/DOCUMENTATION-POLICY.md)
