...
usage() {
  cat <<'USAGE'
Usage: scripts/soak-minimize.sh --test <gtest-filter> --var <env-var> --high <n> [options]
...
Optional:
  ...
  --out-dir <path>    Artifact output dir (default: tests/soak/regressions)
  -h, --help          Show help

Notes:
  - This assumes monotonic behavior for the chosen variable.
  - The script writes repro artifacts under tests/soak/regressions/<timestamp>-<test-slug>/.
USAGE
}
...
BIN_PATH=""
EXTRA_ENV_RAW=""
OUT_DIR="$ROOT/tests/soak/regressions"
